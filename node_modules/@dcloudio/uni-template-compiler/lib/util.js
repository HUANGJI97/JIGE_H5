      ...
      MemberExpression (path) {
        if (path.node.computed) {
          ...
          if (t.isNumericLiteral(property)) {
            path.get('property').replaceWith(t.identifier('__$n' + property.value))
            ...
            state.options.replaceCodes[identifier] = `'+${genCode(path.node.property, true)}+'`
            path.get('property').replaceWith(t.identifier(identifier))
          }
