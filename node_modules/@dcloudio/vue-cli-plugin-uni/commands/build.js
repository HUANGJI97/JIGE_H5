...
async function build (args, api, options) {
  ...
  if (process.UNI_NVUE_ENTRY && Object.keys(process.UNI_NVUE_ENTRY).length) {
  ...
  return new Promise((resolve, reject) => {
    webpack(webpackConfigs, (err, stats) => {
      ...
      if (!args.silent && process.env.UNI_PLATFORM !== 'app-plus') {
        ...
        if (!args.watch) {
          const dirMsg = runByHBuilderX ? '' : `The ${chalk.cyan(targetDirShort)} directory is ready to be deployed.`
